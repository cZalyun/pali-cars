          ...
          <ScrollReveal>
            <div className="space-y-8">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-(--text-muted)">
                    36 {t('hero.reviews')} · {t('hero.trustBadge')}
                  </p>
                </div>
              ...
              <div className="flex items-start gap-4">
                <div className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary-600/10 text-primary-600 dark:text-primary-300">
